...
//     uint64_t current_time = _get_time_ms();

//     // Check if any of the interfaces need to be reloaded
//     for (uint32_t i = 0; i < lifecycle->interfaces.count; i++) {
//         r_module_interface *interface = lifecycle->interfaces.interfaces[i];
//         if (interface->check_for_reload) {
//             interface->check_for_reload(interface);
//         }
//     }
// }
...
// r_module_interface_array array = {0};

// // Add an interface to the array
// r_module_interface *interface = /* ... */;
// if (array.count == array.capacity) {
//     array.capacity = array.capacity ? array.capacity * 2 : 16;
//     array.interfaces = realloc(array.interfaces, array.capacity * sizeof(r_module_interface *));
// }
// array.interfaces[array.count++] = interface;

// // Remove an interface from the array
// r_module_interface *interface_to_remove = /* ... */;
// for (uint32_t i = 0; i < array.count; i++) {
//     if (array.interfaces[i] == interface_to_remove) {
//         array.interfaces[i] = array.interfaces[--array.count];
//         break;
//     }
// }